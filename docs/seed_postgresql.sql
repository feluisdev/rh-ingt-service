...
-- SEED DE DADOS DE PARAMETRIZAÇÃO (Compatível com PostgreSQL / psql)
-- =============================================================================
-- Este script realiza a carga inicial das tabelas de parametrização de RH.
-- Utiliza "ON CONFLICT" para garantir idempotência (ignora duplicados).
-- Respeita a integridade referencial através da ordenação das inserções.
-- =============================================================================
...
-- =============================================================================
INSERT INTO t_tipo_documento (id, codigo, descricao, allowed_extensions, category, is_active, created_date, created_by) VALUES
('a1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e1', 'BI',   'Bilhete de Identidade',           'pdf,jpg,png', 'IDENTIFICACAO', true, NOW(), 'system'),
('a1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e2', 'CNI',  'Cartão Nacional de Identificação', 'pdf,jpg,png', 'IDENTIFICACAO', true, NOW(), 'system'),
('a1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e3', 'PASS', 'Passaporte',                       'pdf,jpg,png', 'IDENTIFICACAO', true, NOW(), 'system'),
('a1e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e1e4', 'CRES', 'Cartão de Residência',             'pdf,jpg,png', 'IDENTIFICACAO', true, NOW(), 'system')
ON CONFLICT (id) DO NOTHING;
...
('e1e1e1e1-e1e1-e1e1-e1e1-e1e1-e1e1e1e7', 'FALTA_INJUSTIFICADA', 'Falta Injustificada',      true,  false, null, 'PESSOAL',   true, NOW(), 'system')
ON CONFLICT (id) DO NOTHING;
...
-- =============================================================================
-- 9. Carreiras (t_career)
-- =============================================================================
INSERT INTO t_career (id, code, name, description, regime, is_active, created_date, created_by) VALUES
('61e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e601', 'REG_GERAL', 'Regime Geral', 'Carreira de Regime Geral', 'GERAL', true, NOW(), 'system'),
('61e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e602', 'REG_ESP', 'Regime Especial', 'Carreira de Regime Especial', 'ESPECIAL', true, NOW(), 'system')
ON CONFLICT (id) DO NOTHING;

-- =============================================================================
-- 10. Categorias (t_category)
-- =============================================================================
INSERT INTO t_category (id, career_id, code, name, description, ordem_progressao, is_active, created_date, created_by) VALUES
('71e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e701', '61e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e601', 'TEC_SUP', 'Técnico Superior', 'Categoria de Nível Superior', 1, true, NOW(), 'system'),
...
-- 11. Escalões (t_grade)
-- =============================================================================
INSERT INTO t_grade (id, category_id, grade_number, codigo, name, salary_index, salary_base, is_active, created_date, created_by) VALUES
('81e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e801', '71e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e701', 1, 'ESC_1', 'Escalão 1', 100.00, 45000.00, true, NOW(), 'system'),
('81e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e802', '71e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e701', 2, 'ESC_2', 'Escalão 2', 110.00, 49500.00, true, NOW(), 'system'),
('81e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e803', '71e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e702', 1, 'ESC_1', 'Escalão 1', 80.00,  30000.00, true, NOW(), 'system')
ON CONFLICT (id) DO NOTHING;

-- =============================================================================
-- 12. Unidades Orgânicas (t_unidade_organica)
-- =============================================================================
...
-- 13. Cargos (t_job)
-- =============================================================================
INSERT INTO t_job (id, code, name, description, nivel, is_active, created_date, created_by) VALUES
('51e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e501', 'GESTOR_RH', 'Gestor de Recursos Humanos', 'Gestão de processos de RH', 1, true, NOW(), 'system'),
('51e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e502', 'ANALISTA_PLAN', 'Analista de Planeamento', 'Análise estratégica e tática', 2, true, NOW(), 'system'),
('51e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e503', 'TEC_FIN', 'Técnico de Finanças', 'Gestão financeira e orçamental', 3, true, NOW(), 'system')
ON CONFLICT (id) DO NOTHING;

-- =============================================================================
-- 14. Funções (t_funcao)
-- =============================================================================
INSERT INTO t_funcao (id, code, name, description, job_id, is_active, created_date, created_by) VALUES
('41e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e401', 'DIR_GERAL', 'Diretor Geral', 'Diretor Geral de Unidade', '51e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e501', true, NOW(), 'system'),
('41e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e402', 'DIR_SERVICO', 'Diretor de Serviço', 'Responsável pelo Serviço', '51e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e501', true, NOW(), 'system'),
('41e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e403', 'TECNICO', 'Técnico', 'Técnico de Nível Superior', null, true, NOW(), 'system'),
('41e1e1e1-e1e1-e1e1-e1e1-e1e1e1e1e404', 'COORD', 'Coordenador', 'Coordenador de Equipa', null, true, NOW(), 'system')
ON CONFLICT (id) DO NOTHING;
