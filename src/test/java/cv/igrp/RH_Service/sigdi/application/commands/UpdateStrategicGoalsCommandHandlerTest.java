...
public class UpdateStrategicGoalsCommandHandlerTest {
    ...
    void testHandle() {
        ...
        // Example:
        // Given
        // UpdateStrategicGoalsCommand command = new UpdateStrategicGoalsCommand(...);
        //
        // When
        // ResponseEntity<StategicGoalResponseDTO> response = updateStrategicGoalsCommandHandler.handle(command);
        //
        // Then
