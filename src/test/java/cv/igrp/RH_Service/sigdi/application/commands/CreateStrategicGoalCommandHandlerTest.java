...
public class CreateStrategicGoalCommandHandlerTest {
    ...
    void testHandle() {
        ...
        // Example:
        // Given
        // CreateStrategicGoalCommand command = new CreateStrategicGoalCommand(...);
        //
        // When
        // ResponseEntity<StategicGoalResponseDTO> response = createStrategicGoalCommandHandler.handle(command);
        //
        // Then
