...
@NoArgsConstructor
@AllArgsConstructor
public class SubmitTacticalActivityCommand implements Command {
  ...
  // controlador (TaticalController.submitTacticalActivity: new
  // SubmitTacticalActivityCommand(id)), fora do alcance de qualquer validação de bean do
