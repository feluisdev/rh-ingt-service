...
public enum TaticalActivityHistoryStatus implements IgrpEnum<String> {
  ...
  TaticalActivityHistoryStatus(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, TaticalActivityHistoryStatus> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(TaticalActivityHistoryStatus::getCode, Function.identity()));
  ...
  */
  public static Optional<TaticalActivityHistoryStatus> fromCode(String code) {
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(TaticalActivityHistoryStatus::getCode, TaticalActivityHistoryStatus::getDescription));
  }
