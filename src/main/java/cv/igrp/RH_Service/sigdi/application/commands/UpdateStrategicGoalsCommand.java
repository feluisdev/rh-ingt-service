...
public class UpdateStrategicGoalsCommand implements Command {
  ...
  // controlador (StrategyController.updateStrategicGoals: new UpdateStrategicGoalsCommand(dto,
  ...
  // caminho, não o corpo. O SpringCommandBus não corre Bean Validation sobre objetos Command,
  // só faz dispatch por classe -- a restrição de presença obrigatória que aqui esteve nunca
  // foi avaliada. Remoção segue o
