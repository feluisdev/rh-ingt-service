...
public enum CostDriverType implements IgrpEnum<String> {

  PER_DIEM("PER_DIEM", "Ajudas de Custo"),
  ...
  CostDriverType(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, CostDriverType> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(CostDriverType::getCode, Function.identity()));
  ...
  */
  public static Optional<CostDriverType> fromCode(String code) {
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(CostDriverType::getCode, CostDriverType::getDescription));
  }
