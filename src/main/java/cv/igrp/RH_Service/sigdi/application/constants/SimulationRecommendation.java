...
public enum SimulationRecommendation implements IgrpEnum<String> {

  CANCEL("CANCEL", "CANCEL"),
    DELAY("DELAY", "DELAY"),
    REDUCE_SCOPE("REDUCE_SCOPE", "REDUCE_SCOPE")
  ;

  private final String code;
  private final String description;

  SimulationRecommendation(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, SimulationRecommendation> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(SimulationRecommendation::getCode, Function.identity()));
  ...
  */
  public static Optional<SimulationRecommendation> fromCode(String code) {
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(SimulationRecommendation::getCode, SimulationRecommendation::getDescription));
  }
