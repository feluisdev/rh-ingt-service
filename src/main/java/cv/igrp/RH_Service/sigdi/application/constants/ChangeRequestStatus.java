...
public enum ChangeRequestStatus implements IgrpEnum<String> {
  ...
  ChangeRequestStatus(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, ChangeRequestStatus> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(ChangeRequestStatus::getCode, Function.identity()));
  ...
  */
  public static Optional<ChangeRequestStatus> fromCode(String code) {
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(ChangeRequestStatus::getCode, ChangeRequestStatus::getDescription));
  }
