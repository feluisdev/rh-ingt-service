...
@Repository
public interface InstitutionalIdentityEntityRepository extends
    ...
    JpaSpecificationExecutor<InstitutionalIdentityEntity>
{
      ...
      default InstitutionalIdentityEntity findByIdOrThrow(UUID id) {
          ...
          .orElseThrow(() -> IgrpResponseStatusException.of(HttpStatus.NOT_FOUND,"InstitutionalIdentityEntity not found for id: " + id));
      }
