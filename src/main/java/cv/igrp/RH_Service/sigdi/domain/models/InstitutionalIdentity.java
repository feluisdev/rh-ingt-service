...
public class InstitutionalIdentity {
  ...
  private InstitutionalIdentity(InstitutionalIdentityId id, Integer cycleYear, String mission, String vision,
                                InstitutionalValues values, String versionComment, boolean isActive,
  ...
  public static InstitutionalIdentity reconstruct(InstitutionalIdentityId id, Integer cycleYear, String mission,
                                                  String vision, InstitutionalValues values, String versionComment,
                                                  boolean isActive, List<StrategicGoal> goals) {
    return new InstitutionalIdentity(id, cycleYear, mission, vision, values, versionComment, isActive, goals);
  }
  ...
  public InstitutionalIdentity activate() {
    return new InstitutionalIdentity(
        this.id, this.cycleYear, this.mission, this.vision,
