...
public class AtivarVinculoLaboralCommandHandler implements CommandHandler<AtivarVinculoLaboralCommand, ResponseEntity<Map<String, ?>>> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AtivarVinculoLaboralCommandHandler.class);

    private final VinculoLaboralRepository vinculoLaboralRepository;

    @IgrpCommandHandler
    public ResponseEntity<Map<String, ?>> handle(AtivarVinculoLaboralCommand command) {
