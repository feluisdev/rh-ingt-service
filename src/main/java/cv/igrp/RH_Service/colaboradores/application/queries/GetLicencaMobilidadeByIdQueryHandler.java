...
public class GetLicencaMobilidadeByIdQueryHandler
        implements QueryHandler<GetLicencaMobilidadeByIdQuery, ResponseEntity<LicencaMobilidadeResponse>> {

    private final LicencaMobilidadeRepository licencaRepository;
    private final LicencaMobilidadeMapper mapper;

    @IgrpQueryHandler
    public ResponseEntity<LicencaMobilidadeResponse> handle(GetLicencaMobilidadeByIdQuery query) {
