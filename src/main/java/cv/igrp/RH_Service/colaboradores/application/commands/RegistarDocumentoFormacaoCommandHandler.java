...
@Component("colabsRegistarDocumentoFormacaoCommandHandler")
@RequiredArgsConstructor
public class RegistarDocumentoFormacaoCommandHandler
        implements CommandHandler<RegistarDocumentoFormacaoCommand, ResponseEntity<DocumentoUploadResponseDTO>> {
    ...
    @IgrpCommandHandler
    public ResponseEntity<DocumentoUploadResponseDTO> handle(RegistarDocumentoFormacaoCommand command) {
        ...
        var saved = documentoRepository.save(Documento.criar(
                "FORMACAO", formacaoId.getValor(), tipoId,
