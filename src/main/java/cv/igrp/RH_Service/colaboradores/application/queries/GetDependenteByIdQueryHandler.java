...
public class GetDependenteByIdQueryHandler
        implements QueryHandler<GetDependenteByIdQuery, ResponseEntity<DependenteResponse>> {

    private final DependenteRepository dependenteRepository;
    private final DependenteMapper mapper;

    @IgrpQueryHandler
    public ResponseEntity<DependenteResponse> handle(GetDependenteByIdQuery query) {
