...
public class GetSaldoAusenciaByIdQueryHandler
        implements QueryHandler<GetSaldoAusenciaByIdQuery, ResponseEntity<SaldoAusenciaResponse>> {

    private final SaldoAusenciaRepository saldoRepository;
    private final SaldoAusenciaMapper mapper;

    @IgrpQueryHandler
    public ResponseEntity<SaldoAusenciaResponse> handle(GetSaldoAusenciaByIdQuery query) {
