...
import cv.igrp.RH_Service.carreiras.application.dto.AuditHistoryEntryDTO;
...
@Component
public class GetCarreirasAuditHistoryQueryHandler
        implements QueryHandler<GetCarreirasAuditHistoryQuery, ResponseEntity<WrapperListaAuditHistoryDTO>> {

    private static final Map<String, Class<?>> CATALOG_MAP = Map.of(
        "careers",    CareerEntity.class,
        "categories", CategoryEntity.class,
        "grades",     GradeEntity.class
    );
    ...
    public ResponseEntity<WrapperListaAuditHistoryDTO> handle(GetCarreirasAuditHistoryQuery query) {
