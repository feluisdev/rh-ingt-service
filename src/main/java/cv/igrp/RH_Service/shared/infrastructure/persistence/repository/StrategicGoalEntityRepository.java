...
@Repository
public interface StrategicGoalEntityRepository extends
    ...
    JpaSpecificationExecutor<StrategicGoalEntity>
{
      ...
      default StrategicGoalEntity findByIdOrThrow(UUID id) {
          ...
          .orElseThrow(() -> IgrpResponseStatusException.of(HttpStatus.NOT_FOUND,"StrategicGoalEntity not found for id: " + id));
      }
