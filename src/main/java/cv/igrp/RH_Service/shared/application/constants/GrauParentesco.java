...
public enum GrauParentesco implements IgrpEnum<String> {
  ...
  GrauParentesco(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, GrauParentesco> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(GrauParentesco::getCode, Function.identity()));
  ...
  */
  public static Optional<GrauParentesco> fromCode(String code) {
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(GrauParentesco::getCode, GrauParentesco::getDescription));
  }
