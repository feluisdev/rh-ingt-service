...
public enum ObjetoTipo implements IgrpEnum<String> {
  ...
  ObjetoTipo(String code, String description) {
    this.code = code;
  ...
  */
  private static final Map<String, ObjetoTipo> CODE_MAP = Arrays.stream(values())
          .collect(Collectors.toMap(ObjetoTipo::getCode, Function.identity()));
  ...
  */
  public static Optional<ObjetoTipo> fromCode(String code) {
  ...
  */
  public static Map<String, String> codeDescriptionMap() {
    return CODE_MAP.values().stream().collect(Collectors.toMap(ObjetoTipo::getCode, ObjetoTipo::getDescription));
  }
