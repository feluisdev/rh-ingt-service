...
@Component
public class GetDocumentoByIdQueryHandler implements QueryHandler<GetDocumentoByIdQuery, ResponseEntity<DocumentoResponseDTO>>{

  private static final Logger LOGGER = LoggerFactory.getLogger(GetDocumentoByIdQueryHandler.class);
