...
@Component
public class AtivarFuncionarioCommandHandler implements CommandHandler<AtivarFuncionarioCommand, ResponseEntity<Map<String, ?>>> {

   private static final Logger LOGGER = LoggerFactory.getLogger(AtivarFuncionarioCommandHandler.class);

  private final FuncionarioRepository funcionarioRepository;

   public AtivarFuncionarioCommandHandler(FuncionarioRepository funcionarioRepository) {
