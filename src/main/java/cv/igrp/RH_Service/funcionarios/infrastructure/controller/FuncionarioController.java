package cv.igrp.RH_Service.funcionarios.infrastructure.controller;
...
public class FuncionarioController {
  ...
  {
      LOGGER.debug("Operation started - Endpoint: {}, Action: {}", "FuncionarioController", "createFuncionario");
      final var command = new CreateFuncionarioCommand(createFuncionarioRequest);
       ...
       LOGGER.debug("Operation finished - Endpoint: {}, Action: {}", "FuncionarioController", "createFuncionario");
  ...
  public ResponseEntity<WrapperListaFuncionarioDTO> getFuncionarios(
    ...
    @RequestParam(value = "0", required = false) String pagina,
    @RequestParam(value = "20", required = false) String tamanho)
  {
      LOGGER.debug("Operation started - Endpoint: {}, Action: {}", "FuncionarioController", "getFuncionarios");
      ...
      LOGGER.debug("Operation finished - Endpoint: {}, Action: {}", "FuncionarioController", "getFuncionarios");
      return ResponseEntity.status(response.getStatusCode())
              .headers(response.getHeaders())
              .body(response.getBody());
  }
  ...
  {
      LOGGER.debug("Operation started - Endpoint: {}, Action: {}", "FuncionarioController", "getFuncionarioById");
      ...
      LOGGER.debug("Operation finished - Endpoint: {}, Action: {}", "FuncionarioController", "getFuncionarioById");
      return ResponseEntity.status(response.getStatusCode())
              .headers(response.getHeaders())
              .body(response.getBody());
  }
  ...
  public ResponseEntity<FuncionarioResponseDTO> updateFuncionario(@Valid @RequestBody FuncionarioRequestDTO updateFuncionarioRequest
    , @PathVariable(value = "funcionarioId") String funcionarioId)
  {
      LOGGER.debug("Operation started - Endpoint: {}, Action: {}", "FuncionarioController", "updateFuncionario");
      final var command = new UpdateFuncionarioCommand(updateFuncionarioRequest, funcionarioId);
       ResponseEntity<FuncionarioResponseDTO> response = commandBus.send(command);
       LOGGER.debug("Operation finished - Endpoint: {}, Action: {}", "FuncionarioController", "updateFuncionario");
        return ResponseEntity.status(response.getStatusCode())
              .headers(response.getHeaders())
              .body(response.getBody());
  }
  ...
  public ResponseEntity<Map<String, ?>> inativarFuncionario(
    @PathVariable(value = "funcionarioId") String funcionarioId)
  {
      LOGGER.debug("Operation started - Endpoint: {}, Action: {}", "FuncionarioController", "inativarFuncionario");
      final var command = new InativarFuncionarioCommand(funcionarioId);
       ResponseEntity<Map<String, ?>> response = commandBus.send(command);
       LOGGER.debug("Operation finished - Endpoint: {}, Action: {}", "FuncionarioController", "inativarFuncionario");
        return ResponseEntity.status(response.getStatusCode())
              .headers(response.getHeaders())
              .body(response.getBody());
  }
