...
ALTER TABLE audit_schema.t_key_results_aud ADD COLUMN criteria_superado NUMERIC(19, 2);
ALTER TABLE audit_schema.t_key_results_aud ADD COLUMN criteria_seguranca_min NUMERIC(19, 2);
ALTER TABLE audit_schema.t_key_results_aud ADD COLUMN criteria_seguranca_max NUMERIC(19, 2);
ALTER TABLE audit_schema.t_key_results_aud ADD COLUMN criteria_alcancado_min NUMERIC(19, 2);
ALTER TABLE audit_schema.t_key_results_aud ADD COLUMN criteria_alcancado_max NUMERIC(19, 2);
ALTER TABLE audit_schema.t_key_results_aud ADD COLUMN criteria_insuficiente NUMERIC(19, 2);
